...
import (
	...
	papermodule "paper/x/paper"
	papermodulekeeper "paper/x/paper/keeper"
	papermoduletypes "paper/x/paper/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "paper"
	Name                 = "paper"
)
...
type App struct {
	*baseapp.BaseApp
	...
	PaperKeeper papermodulekeeper.Keeper
...
func New(
	...
	app.PaperKeeper = *papermodulekeeper.NewKeeper(
		appCodec,
		keys[papermoduletypes.StoreKey],
		keys[papermoduletypes.MemStoreKey],
		app.GetSubspace(papermoduletypes.ModuleName),
	)
	paperModule := papermodule.NewAppModule(appCodec, app.PaperKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(papermoduletypes.ModuleName)
